...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'InstagramImage', fields ['instagram_id']
        db.create_unique('instascraper_instagramimage', ['instagram_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'InstagramImage', fields ['instagram_id']
        db.delete_unique('instascraper_instagramimage', ['instagram_id'])
