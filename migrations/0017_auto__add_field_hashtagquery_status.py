...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagQuery.status'
        db.add_column('instascraper_hashtagquery', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagQuery.status'
        db.delete_column('instascraper_hashtagquery', 'status')
