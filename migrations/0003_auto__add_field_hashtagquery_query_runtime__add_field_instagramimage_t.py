...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagQuery.query_runtime'
        db.add_column('instascraper_hashtagquery', 'query_runtime',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'InstagramImage.thumb_url'
        db.add_column('instascraper_instagramimage', 'thumb_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstagramImage.hashtag'
        db.add_column('instascraper_instagramimage', 'hashtag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instascraper.HashtagQuery'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagQuery.query_runtime'
        db.delete_column('instascraper_hashtagquery', 'query_runtime')

        # Deleting field 'InstagramImage.thumb_url'
        db.delete_column('instascraper_instagramimage', 'thumb_url')

        # Deleting field 'InstagramImage.hashtag'
        db.delete_column('instascraper_instagramimage', 'hashtag_id')
    ...
    models = {
        ...
        'instascraper.hashtagquery': {
            ...
            'query_runtime': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
