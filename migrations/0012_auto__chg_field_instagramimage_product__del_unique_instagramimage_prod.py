...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'InstagramImage', fields ['product']
        db.delete_unique('instascraper_instagramimage', ['product_id'])


        # Changing field 'InstagramImage.product'
        db.alter_column('instascraper_instagramimage', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['configurable.ConfigurableProduct'], null=True))
    ...
    models = {
        ...
        'instascraper.hashtagquery': {
            ...
            'limit': ('django.db.models.fields.PositiveIntegerField', [], {'default': '20'}),
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 17, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
