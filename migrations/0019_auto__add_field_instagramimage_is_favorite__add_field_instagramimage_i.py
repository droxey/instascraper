...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.is_favorite'
        db.add_column('instascraper_instagramimage', 'is_favorite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InstagramImage.is_staff_pick'
        db.add_column('instascraper_instagramimage', 'is_staff_pick',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.is_favorite'
        db.delete_column('instascraper_instagramimage', 'is_favorite')

        # Deleting field 'InstagramImage.is_staff_pick'
        db.delete_column('instascraper_instagramimage', 'is_staff_pick')
    ...
    models = {
        ...
        'instascraper.hashtagquery': {
            ...
            'limit': ('django.db.models.fields.PositiveIntegerField', [], {'default': '200'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'processing_completed_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 8, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'hashtag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['instascraper.HashtagQuery']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instagram_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            ...
            'post_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configurable.ConfigurableProduct']", 'null': 'True', 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'shortcode': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'user_pic': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'product.category': {
