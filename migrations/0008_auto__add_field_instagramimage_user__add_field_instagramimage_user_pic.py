...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.user'
        db.add_column('instascraper_instagramimage', 'user',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'InstagramImage.user_pic'
        db.add_column('instascraper_instagramimage', 'user_pic',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.user'
        db.delete_column('instascraper_instagramimage', 'user')

        # Deleting field 'InstagramImage.user_pic'
        db.delete_column('instascraper_instagramimage', 'user_pic')
    ...
    models = {
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 26, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
