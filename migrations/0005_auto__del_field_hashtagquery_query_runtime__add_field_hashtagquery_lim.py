...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HashtagQuery.limit'
        db.add_column('instascraper_hashtagquery', 'limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'InstagramImage.shortcode'
        db.add_column('instascraper_instagramimage', 'shortcode',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HashtagQuery.limit'
        db.delete_column('instascraper_hashtagquery', 'limit')

        # Deleting field 'InstagramImage.shortcode'
        db.delete_column('instascraper_instagramimage', 'shortcode')
