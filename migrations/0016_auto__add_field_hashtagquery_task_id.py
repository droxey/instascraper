...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagQuery.task_id'
        db.add_column('instascraper_hashtagquery', 'task_id',
                      self.gf('django.db.models.fields.CharField')(max_length=765, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagQuery.task_id'
        db.delete_column('instascraper_hashtagquery', 'task_id')
    ...
    models = {
        ...
        'instascraper.hashtagquery': {
            ...
            'fetch_more_results_on_save': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 24, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
