...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.likes'
        db.add_column('instascraper_instagramimage', 'likes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.likes'
        db.delete_column('instascraper_instagramimage', 'likes')
