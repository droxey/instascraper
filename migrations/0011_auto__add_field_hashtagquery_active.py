...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagQuery.active'
        db.add_column('instascraper_hashtagquery', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagQuery.active'
        db.delete_column('instascraper_hashtagquery', 'active')
