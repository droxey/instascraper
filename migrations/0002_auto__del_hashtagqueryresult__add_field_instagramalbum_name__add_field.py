...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstagramAlbum.name'
        db.add_column('instascraper_instagramalbum', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'InstagramImage.image'
        db.add_column('instascraper_instagramimage', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InstagramImage.published'
        db.add_column('instascraper_instagramimage', 'published',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InstagramAlbum.name'
        db.delete_column('instascraper_instagramalbum', 'name')

        # Deleting field 'InstagramImage.image'
        db.delete_column('instascraper_instagramimage', 'image')

        # Deleting field 'InstagramImage.published'
        db.delete_column('instascraper_instagramimage', 'published')
