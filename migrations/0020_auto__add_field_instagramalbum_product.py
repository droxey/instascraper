...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramAlbum.product'
        db.add_column('instascraper_instagramalbum', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.Product'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramAlbum.product'
        db.delete_column('instascraper_instagramalbum', 'product_id')
    ...
    models = {
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 11, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
