...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HashtagQuery.fetch_more_results_on_save'
        db.add_column('instascraper_hashtagquery', 'fetch_more_results_on_save',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HashtagQuery.fetch_more_results_on_save'
        db.delete_column('instascraper_hashtagquery', 'fetch_more_results_on_save')
