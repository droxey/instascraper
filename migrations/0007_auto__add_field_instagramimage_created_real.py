...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.created_real'
        db.add_column('instascraper_instagramimage', 'created_real',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.created_real'
        db.delete_column('instascraper_instagramimage', 'created_real')
    ...
    models = {
        ...
        'instascraper.instagramimage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_real': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 25, 0, 0)'}),
            'deleted_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
