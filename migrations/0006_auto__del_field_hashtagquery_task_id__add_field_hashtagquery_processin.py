...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HashtagQuery.processing_completed_on'
        db.add_column('instascraper_hashtagquery', 'processing_completed_on',
    ...
    def backwards(self, orm):
        ...
        db.add_column('instascraper_hashtagquery', 'task_id',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=765, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HashtagQuery.processing_completed_on'
        db.delete_column('instascraper_hashtagquery', 'processing_completed_on')
