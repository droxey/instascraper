...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstagramImage.post_url'
        db.add_column('instascraper_instagramimage', 'post_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstagramImage.post_url'
        db.delete_column('instascraper_instagramimage', 'post_url')
